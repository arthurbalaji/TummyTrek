...
import com.tummytrek.security.CustomUserDetailsService;
import com.tummytrek.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                // Public endpoints - allow all auth endpoints
                ...
                .requestMatchers("/api/restaurants/vendor/**").hasRole("VENDOR")
                .requestMatchers("/api/menu-items/vendor/**").hasRole("VENDOR")
                .requestMatchers("/api/orders/vendor/**").hasRole("VENDOR")
                
                // Delivery Partner endpoints
                .requestMatchers("/api/delivery-partners/**").hasRole("DELIVERY_PARTNER")
                .requestMatchers("/api/orders/delivery/**").hasRole("DELIVERY_PARTNER")
